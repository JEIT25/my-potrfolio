...
<template>
  ...
  >
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
      ...
      <a href="#introduction" class="flex items-center gap-2.5 flex-shrink-0 group">
        <div class="w-8 h-8 rounded-lg bg-[#0f172a] text-white font-bold font-mono text-xs flex items-center justify-center shadow-sm group-hover:bg-[#ff2d20] transition-colors">
          JA
        </div>
        <div class="flex flex-col">
          <span class="font-bold text-[#0f172a] text-sm tracking-tight group-hover:text-[#ff2d20] transition-colors">
            Jerold M. Amora
          </span>
      ...
      <div class="flex items-center gap-3">
        ...
        <button
          ...
          class="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-slate-100 border border-slate-200 hover:border-slate-300 text-slate-600 hover:text-slate-900 text-xs transition-colors"
        >
          <svg class="w-3.5 h-3.5 text-[#0f172a]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
          </svg>
          <span>Search</span>
          <kbd class="px-1.5 py-0.5 text-[10px] font-mono text-slate-500 bg-white border border-slate-200 rounded shadow-2xs">
            ⌘K
          </kbd>
        </button>
        ...
        <button
          ...
          class="lg:hidden p-2 rounded-lg bg-slate-100 border border-slate-200 text-slate-700 hover:text-slate-900"
        >
